...
export function WelcomePanel({ suggestions, onSelect }: WelcomePanelProps) {
  return (
    <div className="mx-auto mt-[clamp(22px,8vh,82px)] max-w-[760px] animate-[rise_.65s_ease_both] text-center">
      ...
      <p className="mb-3 text-xs font-semibold uppercase tracking-[1.8px] text-[#e36f3f]">从一句话开始</p>
      <h1 className="font-serif text-[clamp(37px,5vw,59px)] font-normal leading-[1.11] tracking-[-2.2px] text-[#1d1d1b]">把脑海里的画面，<br /><em className="font-normal text-[#e36f3f]">变成真实的作品。</em></h1>
      <p className="mx-auto mt-5 max-w-[500px] text-[13px] leading-7 text-[#827f77]">描述你想看到的场景、风格与光线，剩下的交给 Agnes。</p>
